...
class PolicyNet(nn.Module):
    ...
    def output_policy(self, current_node_feature, enhanced_current_node_feature,
        ...
        # Ensure current_edge is on the same device as enhanced_node_feature
        if current_edge.device != enhanced_node_feature.device:
            current_edge = current_edge.to(enhanced_node_feature.device)
